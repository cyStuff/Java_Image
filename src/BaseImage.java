...
public class BaseImage {
   ...
   * 
   * @param bufferedImage Raw BufferedImage to create Image from.
   */
 ...
 */
  ...
  /**
   * Returns a subsection of the image. May throw an out of bounds exception if
   * the section is not within the image.
   * 
   * @param x Starting x position of the sub-image.
   * @param y Starting y position of the sub-image.
  ...
  /**
   * Set a specific section to an Image. May throw an out of bounds exception if
   * the section is not within the image.
   * 
   * @param x Left-most x coordinate for the sub-image.
   * @param y Upper y coordinate for the sub-image.
